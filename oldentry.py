...
# def _log_event_to_csv(name, camera_id, confidence, result, event_type=None):
...
#     if last_status == "Present":
#         db.log_detection(name, camera_id, confidence, "already_present")
#         _log_event_to_csv(name, camera_id, confidence, "already_present", camera_id)
#         return "already_present"
...
#     db.log_detection(name, camera_id, confidence, result)
#     _log_event_to_csv(name, camera_id, confidence, result, camera_id)
...
#                         _log_event_to_csv(
#                             best_name, self.cam_id,
#                             best_score, "low_confidence", self.cam_id
#                         )
